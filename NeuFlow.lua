...
function NeuFlow:copyToHost_ack(source, dest)
   ...
   function NeuFlow:copyToDev(tensor)
      ...
      if dims == 3 then
         for i = 1,tensor:size(3) do
            etherflow.sendtensor(tensor:select(3,i))
         end
      else
   ...
   function NeuFlow:copyToDev_ack(tensor)
      ...
      if dims == 3 then
         for i = 1,tensor:size(3) do
            etherflow.sendtensor_ack(tensor:select(3,i))
         end
      else
   ...
   function NeuFlow:copyFromDev(tensor)
      ...
      if dims == 3 then
         for i = 1,tensor:size(3) do
            etherflow.receivetensor(tensor:select(3,i))
         end
      else
   ...
   function NeuFlow:copyFromDev_ack(tensor)
      ...
      if dims == 3 then
         for i = 1,tensor:size(3) do
            etherflow.receivetensor_ack(tensor:select(3,i))
